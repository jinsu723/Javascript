...
function changeNumber(num1, num2){
  globalThis.num = num1;  // globalThis를 통해 전역변수 num을 num1값으로 변경
...
console.log(globalThis.str);  // 값 변경 출력 => 전역 객체에 변수를 설정할 수 있고 함수 밖에서도 접근 가능